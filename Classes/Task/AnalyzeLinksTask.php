...
class AnalyzeLinksTask extends AbstractTask
{
    ...
    public function execute(): bool
    {
        try {
            ...
            // \Throwable rather than \Exception: a DivisionByZeroError on a
            // subtree without links is an \Error, so it went straight past the
            // old catch and surfaced as an uncaught fatal.
